        ...
        <table className="min-w-full divide-y divide-gray-200">
          <thead>
            <tr>
              ...
              <th className="px-4 py-3 text-left text-sm font-medium text-gray-600">Write</th>
              <th className="px-4 py-3 text-left text-sm font-medium text-gray-600">Kategori</th>
              <th className="px-4 py-3 text-left text-sm font-medium text-gray-600">Date Post</th>
          ...
          <tbody className="divide-y divide-gray-200">
            {currentItems.map((article, index) => (
              <tr key={article.id}>
                <td className="px-4 py-3 text-sm text-gray-900">{article.id}</td>
                ...
                <td className="px-4 py-3 text-sm text-gray-900">{article.category}</td>
                <td className="px-4 py-3 text-sm text-gray-900">{article.datePost}</td>
